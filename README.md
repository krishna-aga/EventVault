...
* **Dynamic Watermarked Downloads (Phase 12)**: Original clean images and videos are kept securely in storage. When users click download, the server dynamically overlays a professional, custom-styled text watermark consisting of `Event Title | Club | User Role | EventVault` before sending the file.
